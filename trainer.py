...
# added the number of datasets
    ...
    def train(self):
        ...
        # print("==================", model)
        train_data_loader = self.experiment.train.data_loader           # load data
        print("==================", len( train_data_loader))
        if self.experiment.validation:                                  # False
        ...
        while True:
            ...
            # print("trainer:", len(train_data_loader))     # 这与batch_size大小有关系，一共就1000张训练图，batch_size为2时该值长度为500
