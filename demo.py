...
def main():
    ...
    # parser.add_argument('--exp', type=str, default='./experiments/seg_detector/ic15_resnet18_thre.yaml')
    parser.add_argument('exp', type=str)
    # parser.add_argument('--resume', type=str, help='Resume from checkpoint', default='/home/math-tr/jzy/DB/models/ic15_resnet18')
    parser.add_argument('--resume', type=str, help='Resume from checkpoint')
    # parser.add_argument('--image_path', type=str, default='./datasets/icdar2015/test_images/img_99.jpg', help='image path')
    ...
    def inference(self, image_path, visualize=False):
        ...
        with torch.no_grad():
            ...
            if visualize and self.structure.visualizer:
                ...
                print("---------------------")
                cv2.imwrite(os.path.join(self.args['result_dir'], image_path.split('/')[-1].split('.')[0] + '_Hot.jpg'),hot)
                ###
